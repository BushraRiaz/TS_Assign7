...
// Albert Einstein once said, “A person who never made a mistake never tried anything new.”
 // Solution:
var quote:string = "The only thing we have to fear is fear itself.";
 var author:string = "Franklin D. Roosevelt";
//  console.log(author + " Once said, " + '"' + quote + '"');

//  5. Famous Quote 2: Repeat Exercise 4, but this time store the famous person’s name in a variable called famous_person. Then compose your message and store it in a new variable called message. Print your message.
 // Solution:
var famous_person:string = "Benjamin Franklin";
 var message:string = "Three can keep a secret, if two of them are dead.";
...
// 9. Favorite Number: Store your favorite number in a variable. Then, using that variable, create a message that reveals your favorite number. Print that message.
 // Solution:
var fav_number:number = 10;
 var message:string = "My favorite number is " + fav_number;
//  console.log(message);
...
// 11. Names: Store the names of a few of your friends in a array called names. Print each person’s name by accessing each element in the list, one at a time.
 // Solution:
var names:string[] = ["Riaz","Bushra","Moti","Mahdi","Huda"];
//  console.log(names[0]);
//  console.log(names[1]);
//  console.log(names[2]);
//  console.log(names[3]);
...
// to print a series of statements about these items, such as “I would like to own a Honda motorcycle.”
 // Solution:
var transportation:string[] = ["car","bike","motorcycle"]
  ...
  // invite to dinner. Then use your list to print a message to each person, inviting them to dinner.
   // Solution:
  var guests:string[] = ["Riaz","Bushra","Moti"];
...
// Solution:
  // Initial guest list
let guestList: string[] = ["Ayesha", "Fatima", "Aliza", "Saba"];
...
// Solution:
let guestList2: string[] = ["Ayesha", "Nia", "Aliza", "Fatima", "Saba"];
...
// Solution:
let locaArr:string[] = ["Naran","Swat","London"];
// console.log(locaArr);
...
let userNames:string[] = ["Saima", "Khizra", "Saira","Ali", "Usama", 
"admin"]
...
// Solution:
let current_users:string[] = ['admin', 'hifza', 'Taskeen', 'Habiba', 'Laiba']

let new_users: string[] = ['admin', 'Kiran', 'hifza', 'Habiba', 'Iram']
...
// I really love pizza!
// Solution:
let pizzas:string[] = ["fajita", "Malai","Tandoori"]
...
const loc1 = city_country("Lahore", "Pkaistan");
const loc2 = city_country("Sialkot", "Pkaistan");
const loc3 = city_country("Balakot", "Pkaistan");
...
function make_album(artist: string, album_title: string, number_of_tracks?: number) {
  const album: Album= {
    artist: artist,
    title: album_title
  };
...
//   }
// }
// const magicianNames: string [] = ["Harry Houndi", "David", "Teller"]
...
let magicians: string[] = ["Harry Houndi", "David", "Teller"] 
...
//   }
// }
// let greatMagicianArr: string[] = make_great(magicians);
// console.log(magicians);
// console.log(greatMagicianArr);
...
const order1 = ["Turkey", "Lettuce", "Tomato", "Mayonnaise"];
const order2 = ["Ham", "Swiss Cheese", "Mustard"];
const order3: string[] = [];

// orderSandwich(order1);
// orderSandwich(order2);
// orderSandwich(order3);
